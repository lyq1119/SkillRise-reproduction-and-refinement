...
class TaskRunner:
    def run(self, config):
        ...
        if 'skillrise_alfworld' in config.env.env_name.lower():
            from agent_system.environments.skillrise_alfworld import make_envs
        elif 'alfworld' in config.env.env_name.lower():
            from agent_system.environments.alfworld.env_manager import make_envs
        elif 'skillrise_webshop' in config.env.env_name.lower():
            from agent_system.environments.skillrise_webshop import make_envs
