set -x
# DEBUG: SkillRise cross-task meta-RL on WebShop, K=3, short run (2 steps) on a single GPU.
ENGINE=${1:-vllm}
...
GROUP_FILE="${SCRIPT_DIR}/../../../data/groups/skillrise_webshop_K3.jsonl"
...
python3 -m verl.trainer.main_ppo \
    ...
    env.env_name="skillrise_webshop/Webshop" \
    env.seed=0 \
    ...
    trainer.project_name='skillrise_webshop_debug' \
